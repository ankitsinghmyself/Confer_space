...
<form action="registration.php" method="POST">
                            <div class="sign-up-htm">
                                ...
                                <div class="group">
                                    ...
                                    <label for="user" class="label">Male: <input id="user" type="radio" value="Male"  name="gender" checked>Female:<input id="user" value="Female" type="radio"  name="gender"></label>
